...
{
    private readonly ConsoleSettings m_settings;

    private ConsoleTerminal(ConsoleSettings settings) : base(settings)
    {
        m_settings = settings;
    }

    public static ConsoleTerminal CreateTerminal(IEnumerable<MainTask> tasks, ConsoleSettings configuration)
    {
